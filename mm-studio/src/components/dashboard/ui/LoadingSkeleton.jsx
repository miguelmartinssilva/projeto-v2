  ...
  return (
    <div className="flex-1 min-h-screen p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">{Array(4).fill(0).map((_, i) => <motion.div key={i} animate={{ opacity: [0.3, 0.6, 0.3] }} transition={{ duration: 1.5, repeat: Infinity, delay: i * 0.1 }} className="h-24 bg-white/[0.03] rounded-xl" />)}</div>
