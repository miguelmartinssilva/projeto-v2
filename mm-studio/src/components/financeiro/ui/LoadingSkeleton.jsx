  ...
  return (
    <div className="flex-1 min-h-screen p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">{[...Array(4)].map((_, i) => <div key={i} className="h-24 rounded-xl bg-bg-elevated animate-pulse" />)}</div>
