...
export default function MetricCard({ label, value, icon: Icon, color, change, prefix = "", delay = 0 }) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay, duration: 0.3 }}
      ...
      <p className="text-lg font-bold text-text leading-none mb-1">{prefix}{value}</p>
